# trusted-artifact-signer - Policy Library Documentation

> Red Hat Trusted Artifact Signer for supply-chain signing
...
| --------- | ----- | ----------- |
| Component | `trustedArtifactSigner` | Red Hat Trusted Artifact Signer for supply-chain signing |
...
### 📋 Policy: install
> Install and manage Red Hat Trusted Artifact Signer
...
| Parameter | Value | Description |
| --------- | ----- | ----------- |
| Name | `install-rhtas` | Operator policy identifier |
| Namespace | `openshift-operators` | Target namespace for operator |
| Display Name | `Red Hat Trusted Artifact Signer` | Must match the CSV displayName so the generated status check can find it |
...
| Parameter | Value | Description |
| --------- | ----- | ----------- |
| Name | `rhtas-operator` | Operator package name |
